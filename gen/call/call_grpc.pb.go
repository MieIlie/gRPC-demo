...
const (
	...
	CallService_GetCallSession_FullMethodName = "/call.CallService/GetCallSession"
)
...
type CallServiceClient interface {
	...
	GetCallSession(ctx context.Context, in *GetCallSessionRequest, opts ...grpc.CallOption) (*GetCallSessionResponse, error)
}
...
func (c *callServiceClient) GetCallSession(ctx context.Context, in *GetCallSessionRequest, opts ...grpc.CallOption) (*GetCallSessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCallSessionResponse)
	err := c.cc.Invoke(ctx, CallService_GetCallSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CallServiceServer interface {
	...
	GetCallSession(context.Context, *GetCallSessionRequest) (*GetCallSessionResponse, error)
...
func (UnimplementedCallServiceServer) GetCallSession(context.Context, *GetCallSessionRequest) (*GetCallSessionResponse, error) {
...
func _CallService_GetCallSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCallSessionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CallServiceServer).GetCallSession(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CallService_GetCallSession_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CallServiceServer).GetCallSession(ctx, req.(*GetCallSessionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CallService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CallService_GetCallSession_Handler,
		},
	},
